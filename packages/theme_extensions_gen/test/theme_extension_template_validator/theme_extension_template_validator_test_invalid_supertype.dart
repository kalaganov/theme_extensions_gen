...
void main() {
  test('fails when class does not extend ThemeExtension<T>', () async {
          ...
          throwsA(
            predicate(
              (e) =>
                  ...
                  e.message.contains(' must directly extend ThemeExtension<') &&
...
class ThemeExtension<ThemeExtension> {}

@ThemeExtensionTemplate()
abstract interface class AppTheme extends ThemeExtension<ThemeExtension> 
