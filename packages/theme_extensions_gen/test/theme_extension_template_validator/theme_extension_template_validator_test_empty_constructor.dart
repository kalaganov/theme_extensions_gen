...
void main() {
  test('fails when factory constructor has no parameters', () async {
          ...
          throwsA(
            predicate(
              (e) =>
                  ...
                  e.message.contains('The factory constructor of ') &&
                  e.message.contains(' must have at least one parameter.'),
            ),
          ),
        );
      },
...
abstract interface class AppTheme extends ThemeExtension<AppTheme>
  ...
  const factory AppTheme() = _$AppTheme;
}
    ''';
