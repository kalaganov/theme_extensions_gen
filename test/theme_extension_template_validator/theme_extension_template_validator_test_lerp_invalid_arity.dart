...
void main() {
  test('fails when lerp does not have exactly 3 parameters', () async {
          ...
          throwsA(
            predicate(
              (e) =>
                  ...
                  e.message.contains('The "lerp" method or constructor of ') &&
                  e.message.contains('must have exactly 3 parameters.'),
            ),
          ),
        );
      },
