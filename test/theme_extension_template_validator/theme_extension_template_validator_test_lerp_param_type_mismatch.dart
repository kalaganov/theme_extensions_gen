...
void main() {
  test('fails when first two lerp parameters are not same or subtype',
      () async {
          ...
          throwsA(
            predicate(
              (e) =>
                  ...
                  e.message
                      .contains('The first two parameters of "lerp" in ') &&
                  e.message.contains('must be of the same type or subtype of '),
            ),
          ),
        );
      },
